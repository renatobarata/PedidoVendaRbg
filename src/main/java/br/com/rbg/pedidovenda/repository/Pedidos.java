...
import br.com.rbg.pedidovenda.model.vo.DataValor;
import br.com.rbg.pedidovenda.model.vo.UsuarioValor;
...
public class Pedidos implements Serializable {
	...
	public Map<String, BigDecimal> valorTotalPorUsuario() {
		Session session = manager.unwrap(Session.class);
	    ...
	    @SuppressWarnings("unchecked")
		List<UsuarioValor> valoresPorVendedor = criteria.setResultTransformer(Transformers.aliasToBean(UsuarioValor.class)).list();
		
		for (UsuarioValor usuarioValor : valoresPorVendedor) {
